        ...
        <div className="container py-8 mx-auto">
          ...
          <div className="text-center">
            <div className="flex gap-1 justify-center items-center">
              ...
              <Link
                className="website-name -ml-[1px] mt-1 text-2xl font-bold  transition-colors duration-300 transform dark:text-white lg:text-3xl border-teal-500 hover:text-gray-700 dark:hover:text-gray-300 text-teal-500"
                to="/"
              >
                Adventurer
              </Link>
